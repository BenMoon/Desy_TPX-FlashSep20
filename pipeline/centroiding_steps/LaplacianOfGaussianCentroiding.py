...
class LaplacianOfGaussianCentroiding(Centroiding2D):

    def __init__(self, min_sigma=1, max_sigma=10, num_sigma=20, threshold=0.2, overlap=0.5, log_scale=False,
        ...
        super(LaplacianOfGaussianCentroiding, self).__init__(*args, **kwargs)
